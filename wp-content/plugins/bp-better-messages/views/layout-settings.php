...
<script type="text/javascript">
    ...
    jQuery(document).ready(function ($) {
        ...
        function changeReactionStatuses(){
            ...
            console.log( 'changeReactionStatuses' );
...
<div class="wrap">
    ...
    <div class="nav-tab-wrapper" id="bpbm-tabs">
        ...
        <?php if( defined('BM_DEV') ){ ?>
            <a class="nav-tab" id="guest-chat-tab" href="#guest-chat"><?php _ex( 'Guest Chat', 'Settings page', 'bp-better-messages' ); ?></a>
        <?php } ?>
        ...
        <a class="nav-tab" id="sounds-tab" href="#sounds"><?php _ex( 'Sounds', 'Settings page', 'bp-better-messages' ); ?></a>
    ...
    <form action="" method="POST">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top" class="">
                            <th scope="row" valign="top">
                                ...
                                <p style="font-size: 10px;"><?php _ex( 'Enable messages viewer page in WordPress admin', 'Settings page', 'bp-better-messages' ); ?></p>
                            </th>
                            <td>
                            ...
                            <table class="widefat bm-switcher-table">
                                ...
                                <tr valign="top" class="">
                                    ...
                                    <th>
                                        ...
                                        <p style="font-size: 10px;"><?php _ex( 'Disables suggestions when starting new conversation', 'Settings page', 'bp-better-messages' ); ?></p>
                                    </th>
                                </tr>
        ...
        <?php if( defined('BM_DEV') ){ ?>
            <div id="guest-chat" class="bpbm-tab">
                <table class="form-table">
                    <tbody>
                    <tr>
                        <th scope="row">
                            <?php _ex( 'Support Chat', 'Settings page','bp-better-messages' ); ?>
                        </th>
                        <td>
                            <fieldset>
                                <table class="widefat bm-switcher-table">
                                    ...
                                    <tr valign="top" class="">
                                        <td>
                                            <input type="checkbox" name="supportChat" <?php checked( $this->settings[ 'supportChat' ], '1' ); ?> value="1">
                                        </td>
                                        <th>
                                            <?php _ex( 'Enable', 'Settings page','bp-better-messages' ); ?>
                                            <p style="font-size: 10px;"><?php _ex( 'Enable Support Chat widget for not logged in users which allow to contact website support contacts', 'Settings page','bp-better-messages' ); ?></p>
                                        </th>
                                    </tr>
                                    </tbody>
                                </table>
        ...
        <div id="integrations" class="bpbm-tab">
            <div class="nav-tab-wrapper bpbm-sub-tabs">
                <a class="nav-tab <?php if($active_integration === 'bm-buddypress') echo 'nav-tab-active'; ?>" id="bm-buddypress-tab" href="#bm-buddypress">BuddyPress & BuddyBoss</a>
                <a class="nav-tab <?php if($active_integration === 'bm-ultimate-member') echo 'nav-tab-active'; ?>" id="bm-ultimate-member-tab" href="#bm-ultimate-member">Ultimate Member</a>
                <a class="nav-tab <?php if($active_integration === 'bm-peepso') echo 'nav-tab-active'; ?>" id="bm-peepso-tab" href="#bm-peepso">PeepSo</a>
                <a class="nav-tab" id="mycred-tab" href="#mycred">MyCRED</a>
                <a class="nav-tab" id="stickers-tab" href="#stickers"><?php _ex( 'GIFs & Stickers', 'Settings page', 'bp-better-messages' ); ?></a>
                <a class="nav-tab" id="bbpress-tab" href="#bm-bbpress">bbPress</a>
                        ...
                        <td>
                            <fieldset>
                                <table class="widefat bm-switcher-table">
                                    ...
                                    <tr>
                                        <td>
                                            <input name="PSenableGroupsPushs" type="checkbox" <?php if ( ! bp_is_active( 'groups' ) ) echo 'disabled'; ?> <?php checked( $this->settings[ 'PSenableGroupsPushs' ], '1' ); ?> value="1" />
                                            <?php Better_Messages()->functions->license_proposal(); ?>
                                        </td>
                                        <th>
